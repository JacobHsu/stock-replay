"""
Stock search API endpoints for Serverless.
"""
...
from lib.stock_name_fetcher import get_tw_stock_chinese_name
...
def get_day_trading_losers() -> DayTradingLosersResponse:
    ...
    """
    try:
        from lib.day_trading_scraper import get_top3_day_trading_losers
...
def get_us_etf_losers() -> DayTradingLosersResponse:
    ...
    """
    try:
        from lib.us_etf_losers import get_top3_us_etf_losers
...
def get_morning_star_losers() -> DayTradingLosersResponse:
    ...
    """
    try:
        from lib.morning_star_losers import get_top10_morning_star_losers
